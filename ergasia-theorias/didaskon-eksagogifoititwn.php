...
<nav class="nav text-dark bg-light py-2" name="navigation-menu">
	<ul class="nav pl-4">
		...
		<li class="nav-item active">
			<a class="text-dark text-decoration-none small">Εξαγωγή Λίστας Φοιτητών</a>
		</li>
	</ul>
</nav>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="didaskon-eksagogifoititwn.php" style="background-color:black;">Εξαγωγή Λίστας Φοιτητών</a>
...
<div class="container-fluid">
	<h3 class="mt-4">Εξαγωγή Λίστας Φοιτητών</h3>
                            ...
                            echo '<table class="table table-bordered table-striped" id="myTable">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo '<a href="didaskon-eksagogifoititwn-diavasma.php?id_didaskalias='. $row['id_didaskalias'] .'" class="mr-3" title="Εμφάνιση Φοιτητών" data-toggle="tooltip"><span class="fas fa-eye"></span></a>';
                                            echo '<a href="didaskon-eksagogifoititwn-eksagogi.php?id_didaskalias='. $row['id_didaskalias'] .'" class="mr-3" title="Εισαγωγή .csv αρχείου" data-toggle="tooltip"><span class="fas fa-file-import"></span></a>';								 
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
