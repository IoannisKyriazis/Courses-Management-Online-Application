...
include "syndesh-geniki.php";
    ...
    $select= "select * from omadaxrhsth, omadaxrhsth_me_didaskonta, didaskon, dilosi, didaskalia where omadaxrhsth.username = '".$_SESSION['username']."' and omadaxrhsth.username=omadaxrhsth_me_didaskonta.username and didaskon.id_didaskonta=omadaxrhsth_me_didaskonta.id_didaskonta and dilosi.id_didaskalias=didaskalia.id_didaskalias and didaskon.id_didaskonta=didaskalia.id_didaskonta";
...
<nav class="nav text-dark bg-light py-2" name="navigation-menu">
	<ul class="nav pl-4">
		...
		<li class="nav-item active">
			<a class="text-dark text-decoration-none small">Εισαγωγή Βαθμολογίας</a>
		</li>
	</ul>
</nav>
...
<?php  if(is_null($row["pliros_vathmologimeno"])) {   ?>
				   <h4 class="mt-4">Μη Οριστικοποιημένη Βαθμολογία</h4>

						<div class="input-group">
							<div class="form-outline">
								<input type="text" class="form-control rounded" id="myInput1" onkeyup="myFunction1()" placeholder="Αριθμός Μητρώου...">
							</div>
							...
							<div class="form-outline">
								<input type="text" class="form-control rounded" id="myInput2" onkeyup="myFunction2()" placeholder="Όνομα Μαθήματος...">
							</div>
							
							<span class="input-group-text" id="search-addon">
								<i class="fas fa-search"></i>
							</span>
							<a href="didaskon-eisagogivathologias-oristikopoihsh.php" class="btn btn-danger ml-auto"><i class="fa fa-lock"></i> Οριστικοποίηση Βαθμολογίας</a>
						</div>
                    </div>
                    <?php
                            ...
                            echo '<table class="table table-bordered table-striped" id="myTable">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
										...
										echo "<td>" . $row['onoma_foititi'] . "</td>";
										echo "<td>" . $row['eponimo_foititi'] . "</td>";
										echo "<td>" . $row['onoma_mathimatos'] . "</td>";
                                        echo "<td>";
                                            echo '<a href="didaskon-eisagogivathologias-vathmoi.php?id_dilosis='. $row['id_dilosis'] .'" class="mr-3" title="Εισαγωγή Βαθμολογίας" data-toggle="tooltip"><span class="fas fa-sort-numeric-up-alt"></span></a>';								 
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
		   ...
		   <?php } else { ?>
				...
				<h4 class="mt-4">Οριστικοποιημένη Βαθμολογία</h4>
