...
<nav class="nav text-dark bg-light py-2" name="navigation-menu">
	<ul class="nav pl-4">
		...
		<li class="nav-item active">
			<a class="text-dark text-decoration-none small">Δηλώσεις</a>
		</li>
...
<div class="container-fluid">
	<h3 class="mt-4">Λίστα όλων των δηλώσεων των φοιτητών του τμήματος</h3>
	<div class="grammikatoapotitlo"></div>
	
	
		<div class="card bg-light text-dark">
			<div class="card-body">Σε αυτή την σελίδα μπορείτε να να προσθέσετε, να τροποποιήσετε, να διαβάσετε και να διαγράψετε δηλώσεις φοιτητών του τμήματος.</div>
		</div>
	<div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
						...
						<div class="input-group">
							<div class="form-outline">
								<input type="text" class="form-control rounded" id="myInput1" onkeyup="myFunction1()" placeholder="ΑΜ Φοιτητή...">
							</div>
							...
							<a href="diaxeiristis-diloseis-prosthiki.php" class="btn btn-success ml-auto"><i class="fa fa-plus"></i> Δημιουργία Δήλωσης</a>
							<a href="diaxeiristis-diloseis-anoigma.php" class="btn btn-warning ml-auto"><i class="fa fa-lock-open"></i> Άνοιγμα Δηλώσεων</a>
							<a href="diaxeiristis-diloseis-kleisimo.php" class="btn btn-danger ml-auto"><i class="fa fa-lock"></i> Κλείσιμο Δηλώσεων</a>
						</div>
                    </div>
                    <?php
                    ...
                    $sql = "select * from foititis, dilosi where dilosi.AM_foititi=foititis.AM_foititi group by dilosi.AM_foititi";
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            echo '<table class="table table-bordered table-striped" id="myTable">';
                                echo "<thead>";
                                    echo "<tr>";
										echo "<th>ΑΜ Φοιτητή</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo '<a href="diaxeiristis-diloseis-diavasma.php?AM_foititi='. $row['AM_foititi'] .'" class="mr-3" title="Δείτε Περισσότερα" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
											echo '<a href="diaxeiristis-diloseis-tropopoiisi.php?AM_foititi='. $row['AM_foititi'] .'" class="mr-3" title="Τροποποίηση Δήλωσης" data-toggle="tooltip"><span class="fa fa-pen"></span></a>';
										echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
