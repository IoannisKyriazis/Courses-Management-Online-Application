...
<nav class="nav text-dark bg-light py-2" name="navigation-menu">
	<ul class="nav pl-4">
		...
		<a class="text-dark small"><?php echo $row['onoma_diaxeiristi']; ?> <?php echo $row['eponimo_diaxeiristi']; ?></a>
		</li>
	</ul>
</nav>
...
<div class="container-fluid">
	<h3 class="mt-4">Στοιχεία του διαχειριστή <?php echo $row['onoma_diaxeiristi']?> <?php echo $row['eponimo_diaxeiristi']?></h3>
