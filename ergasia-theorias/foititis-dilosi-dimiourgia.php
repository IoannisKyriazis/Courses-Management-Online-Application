...
mysqli_stmt_close($stmt1);
	...
	header("Location: foititis-dilosi-dimiourgia.php");
...
<nav class="nav text-dark bg-light py-2" name="navigation-menu">
	<ul class="nav pl-4">
		...
		<li class="nav-item active">
			<a class="text-dark text-decoration-none small">Δημιουργία Δήλωσης</a>
		</li>
	</ul>
</nav>
...
<div class="container-fluid">
	<h3 class="mt-4">Δήλωση</h3>
	<div class="grammikatoapotitlo"></div>
	
	<div class="container">
            <div class="row justify-content-center">
			<div><h5><?php echo $row['onoma_foititi']; ?> <?php echo $row['eponimo_foititi']; ?> <?php echo $row['AM_foititi']; ?></h5></div>
    ...
    <form name="frmUser" method="post" action="">
        ...
        <div class="form-group mt-5">
			...
			<a href="foititis-dilosi.php" class="btn btn-secondary active" role="button" aria-pressed="true">Ακύρωση / ΠΙΣΩ</a>
        </div>
				...
				<div class="col-lg-6" style="padding-top:50px;">
                    ...
                    $sql = "select * from omadaxrhsth, omadaxrhsth_me_foititi, foititis where omadaxrhsth.username = '".$_SESSION['username']."' and omadaxrhsth.username=omadaxrhsth_me_foititi.username and foititis.AM_foititi=omadaxrhsth_me_foititi.AM_foititi";
                    ...
                    $sql = "select distinct didaskalia.id_didaskalias,mathima.onoma_mathimatos from didaskalia,mathima,dilosi where didaskalia.id_didaskalias not in (select id_didaskalias from dilosi) and didaskalia.id_mathimatos=mathima.id_mathimatos";
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            echo '<table class="table table-bordered table-striped" id="myTable">';
                                echo "<thead>";
