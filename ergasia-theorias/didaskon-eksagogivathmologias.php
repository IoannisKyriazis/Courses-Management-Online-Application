...
<div id="mySidenav" class="sidenav">
  ...
  <a href="didaskon-eksagogivathmologias.php" style="background-color:black;">Εμφάνιση / Εξαγωγή Βαθμολογίας</a>
...
<div class="container-fluid">
	<h3 class="mt-4">Εμφάνιση / Εξαγωγή Βαθμολογίας</h3>
                            ...
                            echo '<table class="table table-bordered table-striped" id="myTable">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo '<a href="didaskon-eksagogivathmologias-diavasma.php?id_didaskalias='. $row['id_didaskalias'] .'" class="mr-3" title="Εμφάνιση Βαθμολογίας" data-toggle="tooltip"><span class="fas fa-eye"></span></a>';
											echo '<a href="didaskon-eksagogivathmologias-eksagogi.php?id_didaskalias='. $row['id_didaskalias'] .'" class="mr-3" title="Εξαγωγή Βαθμολογίας σε .csv" data-toggle="tooltip"><span class="fas fa-file-export"></span></a>';											
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
