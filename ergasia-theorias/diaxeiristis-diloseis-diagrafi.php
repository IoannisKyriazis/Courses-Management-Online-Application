...
if(isset($_POST["id_didaskalias"]) && !empty($_POST["id_didaskalias"])){
	...
	mysqli_query($link,"delete from didaskalia where id_didaskalias='" . $_GET['id_didaskalias'] . "'");
	
	header("location: diaxeiristis-diloseis.php");
    mysqli_close($link);
} else{
  
    if(empty(trim($_GET["id_didaskalias"]))){
       
        header("location: diaxeiristis-diloseis-diagrafi.php");
        exit();
    }
}
?>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            ...
                            <p>
                                ...
                                <a href="diaxeiristis-diloseis.php" class="btn btn-secondary">Όχι</a>
                            </p>
                        </div>
                    </form>
                </div>
