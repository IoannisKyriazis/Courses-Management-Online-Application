...
<nav class="nav text-dark bg-light py-2" name="navigation-menu">
	<ul class="nav pl-4">
		...
		<li class="nav-item active">
			<a class="text-dark text-decoration-none small">Δήλωση</a>
		</li>
	</ul>
</nav>
...
<div class="container-fluid">
	<h3 class="mt-4">Δήλωση Φοιτητή, <?php echo $row1['onoma_foititi']; ?> <?php echo $row1['eponimo_foititi']; ?></h3>
	...
	<div class="container">
            <div class="row justify-content-center">
				...
				<?php  if($row1["oristikopoihmenh_dilosi"] == "OXI" || is_null($row1["oristikopoihmenh_dilosi"])) { echo '<a href="foititis-dilosi-dimiourgia.php?AM_foititi='. $row1['AM_foititi'] .'" class="btn btn-success ml-auto"><i class="fa fa-plus"></i> Προσθήκη Μαθήματος</a>';  echo '<a href="foititis-dilosi-oristikopoiisi.php?AM_foititi='. $row1['AM_foititi'] .'" class="btn btn-warning ml-auto"><i class="fa fa-check"></i> Οριστικοποίηση Δήλωσης</a>';?>
				   <h4 class="mt-4">Μη Οριστικοποιημένη Δήλωση</h4>
				   <?php
                            ...
                            echo '<table class="table table-bordered table-striped" id="myTable">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
										...
										echo "<td>";                                     
											echo '<a href="foititis-dilosi-diagrafi.php?id_didaskalias='. $row['id_didaskalias'] .'" class="mr-3" title="Διαγραφή Μαθήματος" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
				...
				<?php } else { ?>
				<h4 class="mt-4">Οριστικοποιημένη Δήλωση</h4>
				<?php
