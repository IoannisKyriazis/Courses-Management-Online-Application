...
<div class="container-fluid">
	<h3 class="mt-4">Καλώς ήλθατε, <?php echo $row['onoma_didaskonta']?> <?php echo $row['eponimo_didaskonta']?>!</h3>
	<div class="grammikatoapotitlo"></div>
	
	
		<div class="card bg-light text-dark">
			<div class="card-body bg-success">Έχετε πραγματοποιήσει επιτυχή είσοδο στην εφαρμογή και βρίσκεστε στο περιβάλλον του διδάσκοντα.</div>
		</div>
		
		<div class="card bg-light text-dark">
			<div class="card-body">Από το παρόν περιβάλλον ως διδάσκοντας μπορείτε να εισάγετε βαθμολογίες μαθημάτων, να εξάγετε δεδομένα και στατιστικά.</div>
		</div>
	<div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $sql = "select * from didaskalia, mathima, didaskon, omadaxrhsth,omadaxrhsth_me_didaskonta where omadaxrhsth.username='" . $_SESSION['username'] . "' and omadaxrhsth.username=omadaxrhsth_me_didaskonta.username and mathima.id_mathimatos=didaskalia.id_mathimatos and didaskalia.id_didaskonta=didaskon.id_didaskonta and didaskon.eponimo_didaskonta='".$row['eponimo_didaskonta']."'";
                            ...
                            echo '<table class="table table-bordered table-striped" id="myTable">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo '<a href="didaskon-arxiki-diavasma.php?id_didaskalias='. $row['id_didaskalias'] .'" class="mr-3" title="Δείτε Περισσότερα" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';								 
                                            echo '<a href="didaskon-arxiki-tropopoiisi.php?id_didaskalias='. $row['id_didaskalias'] .'" class="mr-3" title="Τροποποίηση Τρόπου Βαθμολόγησης" data-toggle="tooltip"><span class="fa fa-pen"></span></a>';
										 echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
