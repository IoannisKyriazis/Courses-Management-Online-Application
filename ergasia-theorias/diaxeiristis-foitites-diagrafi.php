...
if(isset($_POST["AM_foititi"]) && !empty($_POST["AM_foititi"])){
    
    require_once "syndesh-geniki.php";
    
	mysqli_query($link,"delete from omadaxrhsth where username in (select omadaxrhsth.username from foititis,omadaxrhsth,omadaxrhsth_me_foititi where foititis.AM_foititi=omadaxrhsth_me_foititi.AM_foititi and omadaxrhsth.username=omadaxrhsth_me_foititi.username and foititis.AM_foititi='" . $_POST['AM_foititi'] . "')");
	mysqli_query($link,"DELETE FROM foititis where AM_foititi='" . $_POST['AM_foititi'] . "'");
	header("location: diaxeiristis-foitites.php");
    mysqli_close($link);
} else{
  
    if(empty(trim($_GET["AM_foititi"]))){
       
        header("location: diaxeiristis-foitites-diagrafi.php");
        exit();
    }
}
?>
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            <input type="hidden" name="AM_foititi" value="<?php echo trim($_GET["AM_foititi"]); ?>"/>
                            ...
                            <p>
                                ...
                                <a href="diaxeiristis-foitites.php" class="btn btn-secondary">Όχι</a>
                            </p>
                        </div>
                    </form>
                </div>
