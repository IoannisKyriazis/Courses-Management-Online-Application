...
include "diaxeiristis-elegxos.php";
 include_once"syndesh-geniki.php";
...
$resultset_1 = mysqli_query($link, "select * from mathima where id_mathimatos='".$id_mathimatoss."';")  or die(mysql_error());
$count = mysqli_num_rows($resultset_1);


if($count == 0){
		
$stmt1 = $link->prepare("INSERT INTO mathima (id_mathimatos, onoma_mathimatos, perigrafi_mathimatos, proapaitoumenamathimata) VALUES (?, ?, ?, ?)");
$id_mathimatos=$_POST['id_mathimatos'];
$onoma_mathimatos=$_POST['onoma_mathimatos'];
$perigrafi_mathimatos=$_POST['perigrafi_mathimatos'];
$proapaitoumenamathimata=$_POST['proapaitoumenamathimata'];
$stmt1->bind_param("ssss", $id_mathimatos, $onoma_mathimatos, $perigrafi_mathimatos, $proapaitoumenamathimata);
$stmt1->execute();

	header("Location: diaxeiristis-mathimata.php");
...
mysqli_stmt_close($stmt3);
	...
	header("Location: diaxeiristis-mathimata-prosthiki.php");
...
<div class="container-fluid">
	<h3 class="mt-4">Προσθήκη Μαθήματος</h3>
...
<div class="form-group">
        ...
        <div class="form-group">
            <input type="text" name="onoma_mathimatos" class="form-control" placeholder="Όνομα Μαθήματος" required="required">	
        </div>
		
		<div class="form-group">
            <textarea name="perigrafi_mathimatos" class="form-control" placeholder="Περιγραφή" required="required" rows="10"></textarea>
        </div>
		
		<div class="form-group">
            <input type="text" name="proapaitoumenamathimata" class="form-control" placeholder="Προαπαιτούμενα Μαθήματα" required="required">	
        </div>
		
        <div class="form-group mt-5">
            <button type="submit" name="submit" value="Submit" class="btn btn-primary">Προσθήκη</button>
			<a href="diaxeiristis-mathimata.php" class="btn btn-secondary active" role="button" aria-pressed="true">Ακύρωση / ΠΙΣΩ</a>
        </div>
