...
$id_mathimatoss=$_POST['id_mathimatos'];
$resultset_1 = mysqli_query($link, "select * from didaskalia where id_mathimatos='".$id_mathimatoss."';")  or die(mysql_error());
$count = mysqli_num_rows($resultset_1);


if($count == 0){
		
$stmt1 = $link->prepare("INSERT INTO didaskalia (id_mathimatos, etos_didaskalias, eksamino_didaskalias, id_didaskonta, varostheorias, varosergastiriou, periorismostheorias, periorismosergastiriou) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
$id_mathimatos=$_POST['id_mathimatos'];
$etos_didaskalias=$_POST['etos_didaskalias'];
$eksamino_didaskalias=$_POST['eksamino_didaskalias'];
$id_didaskonta=$_POST['id_didaskonta'];
$varostheorias=$_POST['varostheorias'];
$varosergastiriou=$_POST['varosergastiriou'];
$periorismostheorias=$_POST['periorismostheorias'];
$periorismosergastiriou=$_POST['periorismosergastiriou'];
$stmt1->bind_param("ssssssss", $id_mathimatos, $etos_didaskalias, $eksamino_didaskalias, $id_didaskonta, $varostheorias, $varosergastiriou, $periorismostheorias, $periorismosergastiriou);
$stmt1->execute();

	header("Location: diaxeiristis-didaskalies.php");
...
mysqli_stmt_close($stmt3);
	...
	header("Location: diaxeiristis-didaskalies-prosthiki.php");
...
<div class="container-fluid">
	<h3 class="mt-4">Προσθήκη Διδασκαλίας</h3>
    ...
    <form name="frmUser" method="post" action="">
        ...
        <div class="form-group">
            <input type="text" name="id_mathimatos" class="form-control" placeholder="ID Μαθήματος" required="required">	
        </div>
		...
		<div class="form-group">
            <input type="text" name="id_didaskonta" class="form-control" placeholder="ID Διδάσκοντα" required="required">	
        </div>
		
		<div class="form-group">
           <input type="text" name="varostheorias" class="form-control" placeholder="Βάρος Θεωρίας (π.χ. 0,50)" required="required">		
        </div>
		
		<div class="form-group">
            <input type="text" name="varosergastiriou" class="form-control" placeholder="Βάρος Εργαστηρίου (π.χ. 0,50)" required="required">		
        </div>
		
		<div class="form-group">
            <input type="text" name="periorismostheorias" class="form-control" placeholder="Περιορισμός Θεωρίας (π.χ. 5)" required="required">	
        </div>
		
		<div class="form-group">
            <input type="text" name="periorismosergastiriou" class="form-control" placeholder="Περιορισμός Εργαστηρίου (π.χ. 5)" required="required">		
        </div>
