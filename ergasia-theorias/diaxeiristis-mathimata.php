...
<div class="container-fluid">
	<h3 class="mt-4">Λίστα όλων των μαθημάτων του τμήματος</h3>
	<div class="grammikatoapotitlo"></div>
	
	
		<div class="card bg-light text-dark">
			<div class="card-body">Σε αυτή την σελίδα μπορείτε να να προσθέσετε, να τροποποιήσετε, να διαβάσετε και να διαγράψετε μαθήματα του τμήματος.</div>
		</div>
	<div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
						...
						<div class="input-group">
							...
							<a href="diaxeiristis-mathimata-prosthiki.php" class="btn btn-success ml-auto"><i class="fa fa-plus"></i> Προσθήκη Μαθήματος</a>
						</div>
                    </div>
                    <?php
                            ...
                            echo '<table class="table table-bordered table-striped" id="myTable">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo '<a href="diaxeiristis-mathimata-diavasma.php?id_mathimatos='. $row['id_mathimatos'] .'" class="mr-3" title="Δείτε Περισσότερα" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
											echo '<a href="diaxeiristis-mathimata-tropopoiisi.php?id_mathimatos='. $row['id_mathimatos'] .'" class="mr-3" title="Τροποποίηση Στοιχείων" data-toggle="tooltip"><span class="fa fa-pen"></span></a>';
											echo '<a href="diaxeiristis-mathimata-diagrafi.php?id_mathimatos='. $row['id_mathimatos'] .'" class="mr-3" title="Διαγραφή" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
