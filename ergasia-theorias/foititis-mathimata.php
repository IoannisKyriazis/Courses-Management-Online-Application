...
<div id="mySidenav" class="sidenav">
  ...
  <div class="mt-5"></div>
  <li class="ena">
  <a href="foititis-eisagogivathologias.php">Εισαγωγή Βαθμολογίας</a>
  <a href="foititis-ananeosivathmologias.php">Ανανέωση Βαθμολογίας</a>
  <a href="foititis-eksagogivathmologias.php">Εμφάνιση / Εξαγωγή Βαθμολογίας</a>
  <a href="foititis-eksagogifoititwn.php">Εξαγωγή Λίστας Φοιτητών</a>
  <a href="foititis-statistika-arithmosanatethimenwn.php">Στατιστικά</a>
                            ...
                            echo '<table class="table table-bordered table-striped" id="myTable">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo '<a href="foititis-diavasma.php?id_mathimatos='. $row['id_mathimatos'] .'" class="mr-3" title="Δείτε Πληροφορίες" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
