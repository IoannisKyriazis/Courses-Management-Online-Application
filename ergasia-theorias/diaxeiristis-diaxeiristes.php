...
<nav class="nav text-dark bg-light py-2" name="navigation-menu">
	<ul class="nav pl-4">
		...
		<li class="nav-item active">
			<a class="text-dark text-decoration-none small">Διαχειριστές</a>
		</li>
...
<div class="container-fluid">
	<h3 class="mt-4">Λίστα όλων των διαχειριστών του συστήματος</h3>
	<div class="grammikatoapotitlo"></div>
	
	
		<div class="card bg-light text-dark">
			<div class="card-body">Σε αυτή την σελίδα μπορείτε να να προσθέσετε, να τροποποιήσετε, να διαβάσετε και να διαγράψετε διαχειριστές του συστήματος.</div>
		</div>
	<div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
						...
						<div class="input-group">
							<div class="form-outline">
								<input type="text" class="form-control rounded" id="myInput" onkeyup="myFunction()" placeholder="Επώνυμο Διαχειριστή...">
							</div>
							
							<span class="input-group-text" id="search-addon">
								<i class="fas fa-search"></i>
							</span>
							<a href="diaxeiristis-diaxeiristes-prosthiki.php" class="btn btn-success ml-auto"><i class="fa fa-plus"></i> Προσθήκη Διαχειριστή</a>
						</div>
                    </div>
                    <?php
                    ...
                    $sql = "select * from omadaxrhsth, omadaxrhsth_me_diaxeiristi, diaxeiristis where omadaxrhsth.username=omadaxrhsth_me_diaxeiristi.username and diaxeiristis.id_diaxeiristi=omadaxrhsth_me_diaxeiristi.id_diaxeiristi";
                        ...
                        if(mysqli_num_rows($result) > 0){
                            echo '<table class="table table-bordered table-striped" id="myTable">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        echo "<td>" . $row['id_diaxeiristi'] . "</td>";
										echo "<td>" . $row['eponimo_diaxeiristi'] . "</td>";
                                        echo "<td>";
                                            echo '<a href="diaxeiristis-diaxeiristes-diavasma.php?id_diaxeiristi='. $row['id_diaxeiristi'] .'" class="mr-3" title="Δείτε Περισσότερα" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
											echo '<a href="diaxeiristis-diaxeiristes-tropopoiisi.php?id_diaxeiristi='. $row['id_diaxeiristi'] .'" class="mr-3" title="Τροποποίηση Στοιχείων" data-toggle="tooltip"><span class="fa fa-id-card"></span></a>';
											echo '<a href="diaxeiristis-diaxeiristes-diagrafi.php?id_diaxeiristi='. $row['id_diaxeiristi'] .'" class="mr-3" title="Διαγραφή" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
                            ...
                            echo '<div class="alert alert-danger"><em>Δεν βρέθηκαν διαχειριστές του συστήματος!</em></div>';
                        }
                    } else{
