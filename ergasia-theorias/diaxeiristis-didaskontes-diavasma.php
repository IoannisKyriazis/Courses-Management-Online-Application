...
<nav class="nav text-dark bg-light py-2" name="navigation-menu">
	<ul class="nav pl-4">
		...
		<a class="text-dark small"><?php echo $row['onoma_didaskonta']; ?> <?php echo $row['eponimo_didaskonta']; ?></a>
		</li>
	</ul>
</nav>
...
<div class="container-fluid">
	<h3 class="mt-4">Στοιχεία του διδάσκοντα <?php echo $row['onoma_didaskonta']?> <?php echo $row['eponimo_didaskonta']?></h3>
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-header"><h3 class="text-center font-weight-light my-4">Στοιχεία</h3></div>
							...
							<form name="login" action="login.php" method="post">
									...
									<input type="text" name="" class="form-control" value="<?php echo $row['id_didaskonta']; ?>" disabled>
                                    ...
                                    <input type="text" name="" class="form-control" value="<?php echo $row['onoma_didaskonta']; ?>" disabled>
									
									<div class="input-group-prepend mt-5"><span class="input-group-text">Επώνυμο</span></div>
                                    <input type="text" name="" class="form-control" value="<?php echo $row['eponimo_didaskonta']; ?>" disabled>
									
									<div class="input-group-prepend mt-5"><span class="input-group-text">E-mail</span></div>
                                    <input type="text" name="" class="form-control" value="<?php echo $row['email_didaskonta']; ?>" disabled>
									
									<div class="input-group-prepend mt-5"><span class="input-group-text">Βαθμίδα</span></div>
                                    <input type="text" name="" class="form-control" value="<?php echo $row['vathmida_didaskonta']; ?>" disabled>
