...
<?php
 ...
 $select= "select * from omadaxrhsth, omadaxrhsth_me_foititi, foititis where omadaxrhsth.username = '".$_SESSION['username']."' and omadaxrhsth.username=omadaxrhsth_me_foititi.username and foititis.AM_foititi=omadaxrhsth_me_foititi.AM_foititi";
	...
	mysqli_query($link,"update foititis set oristikopoihmenh_dilosi='NAI' where AM_foititi='" . $row['AM_foititi'] . "'");
	
	header('location: foititis-dilosi.php?AM_foititi='. $row['AM_foititi'] .'');
    mysqli_close($link);
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            ...
                            <p>
								...
								<?php  echo '<a href="foititis-dilosi.php" class="btn btn-secondary">Όχι</a>'; ?>
                            </p>
                        </div>
                    </form>
                </div>
