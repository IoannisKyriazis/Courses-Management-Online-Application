...
<nav class="nav text-dark bg-light py-2" name="navigation-menu">
	<ul class="nav pl-4">
		...
		<li class="nav-item active">
			<a class="text-dark text-decoration-none small">Διδασκαλίες</a>
		</li>
...
<div class="container-fluid">
	<h3 class="mt-4">Λίστα όλων των διδασκαλιών του τμήματος</h3>
	<div class="grammikatoapotitlo"></div>
	
	
		<div class="card bg-light text-dark">
			<div class="card-body">Σε αυτή την σελίδα μπορείτε να να προσθέσετε, να τροποποιήσετε, να διαβάσετε και να διαγράψετε διδασκαλίες του τμήματος.</div>
		</div>
	<div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
						...
						<div class="input-group">
							...
							<a href="diaxeiristis-didaskalies-prosthiki.php" class="btn btn-success ml-auto"><i class="fa fa-plus"></i> Προσθήκη Διδασκαλίας</a>
						</div>
                    </div>
                    <?php
                    ...
                    $sql = "select * from didaskalia, didaskon, mathima where didaskalia.id_mathimatos=mathima.id_mathimatos and didaskalia.id_didaskonta=didaskon.id_didaskonta";
                        ...
                        if(mysqli_num_rows($result) > 0){
                            echo '<table class="table table-bordered table-striped" id="myTable">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        echo "<td>" . $row['id_didaskalias'] . "</td>";
										echo "<td>" . $row['onoma_mathimatos'] . "</td>";
										echo "<td>" . $row['eponimo_didaskonta'] . "</td>";
                                        echo "<td>";
                                            echo '<a href="diaxeiristis-didaskalies-diavasma.php?id_didaskalias='. $row['id_didaskalias'] .'" class="mr-3" title="Δείτε Περισσότερα" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
											echo '<a href="diaxeiristis-didaskalies-tropopoiisi.php?id_didaskalias='. $row['id_didaskalias'] .'" class="mr-3" title="Τροποποίηση Στοιχείων" data-toggle="tooltip"><span class="fa fa-pen"></span></a>';
											echo '<a href="diaxeiristis-didaskalies-diagrafi.php?id_didaskalias='. $row['id_didaskalias'] .'" class="mr-3" title="Διαγραφή" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
