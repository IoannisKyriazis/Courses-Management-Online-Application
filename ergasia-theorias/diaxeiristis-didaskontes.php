...
<nav class="nav text-dark bg-light py-2" name="navigation-menu">
	<ul class="nav pl-4">
		...
		<li class="nav-item active">
			<a class="text-dark text-decoration-none small">Διδάσκοντες</a>
		</li>
...
<div class="container-fluid">
	<h3 class="mt-4">Λίστα όλων των διδασκόντων του τμήματος</h3>
	<div class="grammikatoapotitlo"></div>
	
	
		<div class="card bg-light text-dark">
			<div class="card-body">Σε αυτή την σελίδα μπορείτε να να προσθέσετε, να τροποποιήσετε, να διαβάσετε και να διαγράψετε διδασκοντες του τμήματος.</div>
		</div>
	<div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
						...
						<div class="input-group">
							<div class="form-outline">
								<input type="text" class="form-control rounded" id="myInput" onkeyup="myFunction()" placeholder="Επώνυμο Διδάσκοντα...">
							</div>
							
							<span class="input-group-text" id="search-addon">
								<i class="fas fa-search"></i>
							</span>
							<a href="diaxeiristis-didaskontes-prosthiki.php" class="btn btn-success ml-auto"><i class="fa fa-plus"></i> Προσθήκη Διδάσκοντα</a>
						</div>
                    </div>
                    <?php
                    ...
                    $sql = "select * from omadaxrhsth, omadaxrhsth_me_didaskonta, didaskon where omadaxrhsth.username=omadaxrhsth_me_didaskonta.username and didaskon.id_didaskonta=omadaxrhsth_me_didaskonta.id_didaskonta";
                        ...
                        if(mysqli_num_rows($result) > 0){
                            echo '<table class="table table-bordered table-striped" id="myTable">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        echo "<td>" . $row['id_didaskonta'] . "</td>";
										echo "<td>" . $row['eponimo_didaskonta'] . "</td>";
                                        echo "<td>";
                                            echo '<a href="diaxeiristis-didaskontes-diavasma.php?id_didaskonta='. $row['id_didaskonta'] .'" class="mr-3" title="Δείτε Περισσότερα" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
											echo '<a href="diaxeiristis-didaskontes-tropopoiisi.php?id_didaskonta='. $row['id_didaskonta'] .'" class="mr-3" title="Τροποποίηση Στοιχείων" data-toggle="tooltip"><span class="fa fa-id-card"></span></a>';
											echo '<a href="diaxeiristis-didaskontes-diagrafi.php?id_didaskonta='. $row['id_didaskonta'] .'?username='. $row['username'] .'" class="mr-3" title="Διαγραφή" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
                            ...
                            echo '<div class="alert alert-danger"><em>Δεν βρέθηκαν διδασκοντες του τμήματος!</em></div>';
                        }
                    } else{
