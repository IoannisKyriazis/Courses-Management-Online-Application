...
include "diaxeiristis-elegxos.php";
 include_once"syndesh-geniki.php";
	...
	if(count($_POST)>0) {
mysqli_query($link,"UPDATE mathima set onoma_mathimatos='" . $_POST['onoma_mathimatos'] . "', perigrafi_mathimatos='" . $_POST['perigrafi_mathimatos'] . "', proapaitoumenamathimata='" . $_POST['proapaitoumenamathimata'] . "' WHERE id_mathimatos='" . $_GET['id_mathimatos'] . "'");
...
<div class="container-fluid">
	<h3 class="mt-4">Τροποποίηση μαθήματος</h3>
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-header"><h3 class="text-center font-weight-light my-4">Στοιχεία</h3></div>
							...
							<form name="frmUser" method="post" action="">
									...
									<input type="text" name="id_mathimatos" class="form-control" value="<?php echo $row['id_mathimatos']; ?>" disabled>
									
									<div class="input-group-prepend mt-5"><span class="input-group-text">Όνομα Μαθήματος</span></div>
                                    <input type="text" name="onoma_mathimatos" class="form-control" value="<?php echo $row['onoma_mathimatos']; ?>">
									
									<div class="input-group-prepend mt-5"><span class="input-group-text">Περιγραφή</span></div>
									<textarea name="perigrafi_mathimatos" class="form-control" rows="10"><?php echo $row['perigrafi_mathimatos']; ?></textarea>
									
									
									<div class="input-group-prepend mt-5"><span class="input-group-text">Προαπαιτούμενα Μαθήματα</span></div>
                                    <input type="text" name="proapaitoumenamathimata" class="form-control" value="<?php echo $row['proapaitoumenamathimata']; ?>" >
