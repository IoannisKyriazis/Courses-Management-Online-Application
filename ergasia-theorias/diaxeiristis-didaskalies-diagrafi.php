...
if(isset($_POST["id_didaskalias"]) && !empty($_POST["id_didaskalias"])){
    ...
    mysqli_query($link,"DELETE FROM didaskalia where id_didaskalias='" . $_POST['id_didaskalias'] . "'");
    ...
    if(empty(trim($_GET["id_didaskalias"]))){
        ...
        header("location: diaxeiristis-didaskalies-diagrafi.php");
        exit();
    }
}
?>
...
<nav class="nav text-dark bg-light py-2" name="navigation-menu">
	<ul class="nav pl-4">
		...
		<li class="nav-item">
			<a href="diaxeiristis-foitites.php" class="text-muted text-decoration-none small">Διδασκαλίες</a>
		</li>
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            ...
                            <p>Θέλετε να διαγράψετε αυτή την διδασκαλία; Η ενέργεια είναι μη αναστρέψιμη.</p>
                            <p>
                                <input type="submit" value="Ναι" class="btn btn-danger" >
                                <a href="diaxeiristis-didaskalies.php" class="btn btn-secondary">Όχι</a>
                            </p>
                        </div>
                    </form>
                </div>
